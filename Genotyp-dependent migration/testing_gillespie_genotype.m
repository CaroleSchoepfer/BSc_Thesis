...
mu = 1/(10*(K1+K2));       % mutation probability upon reproduction
mWT = 1e-3;    % migration rate from deme 1 to deme 2
mM = 1e-3;    % migration rate from deme 2 to deme 1
...
result = Gillespie_fct_geno(Nit, fA, gA, NA10, NA20, fB, gB, NB10, NB20, K1, K2, mu, mWT, mM, theta1, theta2);
